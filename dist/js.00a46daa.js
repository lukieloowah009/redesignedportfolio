...
var Fade = /*#__PURE__*/function (_Highway$Transition) {
  ...
  _createClass(Fade, [{
    ...
    value: function _in(_ref) {
      ...
      }).fromTo(to.children[0].children[1], 1, {
        opacity: 0
      }, {
        opacity: 1
      }).fromTo(to.children[0].children[0], 1, {
        opacity: 0
      }, {
        opacity: 1
      });
...
var _default = Fade;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","gsap":"node_modules/gsap/index.js"}],"js/transition-education.js":[function(require,module,exports) {
"use strict";
...
var Fade2 = /*#__PURE__*/function (_Highway$Transition) {
  _inherits(Fade2, _Highway$Transition);

  var _super = _createSuper(Fade2);
  ...
  _createClass(Fade2, [{
    ...
    value: function _in(_ref) {
      ...
      t1.fromTo(to, 0.5, {
        ...
        opacity: 1
      }).fromTo(to.children[0].children[0].children[0], 0.3, {
        opacity: 0
      }, {
        opacity: 1
      }).fromTo(to.children[0].children[0].children[1], 0.3, {
        opacity: 0
      }, {
        opacity: 1
      }).fromTo(to.children[0].children[0].children[2], 0.3, {
        opacity: 0
      }, {
        opacity: 1
      }).fromTo(to.children[0].children[0].children[3], 0.3, {
        opacity: 0
      }, {
        opacity: 1
      });
...
var _transitionEducation = _interopRequireDefault(require("./transition-education"));
...
var H = new _highway.default.Core({
  transitions: {
    ...
    education: _transitionEducation.default,
    work: _transitionEducation.default,
    contact: _transition.default,
    miscellaneous: _transition.default
  }
});
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","./transition":"js/transition.js","./transition-education":"js/transition-education.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
